...
class DetailInspectionEvent with _$DetailInspectionEvent {
  ...
  const factory DetailInspectionEvent.getDetailInspectionList(String resultId) =  _GetDetailInspectionList;
  const factory DetailInspectionEvent.getDetailInspection(String machineId,int number,String tanggal) = _GetDetailInspection;
  const factory DetailInspectionEvent.getDetailByDate(String resultId) = _GetDetailByDate;
