...
class ResultEvent with _$ResultEvent {
  ...
  const factory ResultEvent.getResultByDate(String machineId ,String tanggal) = _GetResultByDate;
  const factory ResultEvent.getResultByDateForHomepage(String machineId,String tanggal) = _GetResultByDateForHomepage;
