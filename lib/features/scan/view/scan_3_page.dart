...
class _Scan3PageState extends State<Scan3Page> {
  ...
  void initState() {
    ...
    super.initState();
    context.read<InspectionItemBloc>().add(const InspectionItemEvent.GetInspectionItem());
        ...
        body: SingleChildScrollView(
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Container(
                  child: Center(child: Image.asset('assets/images/mesin.jpg')),
                ),
                SizedBox(height: 20),
                ...
                Center(child: tombol("Submit", onPressed))
              ],
            ),
          ),
        ));
