...
class _HomePageState extends State<HomePage> {
  late final TextEditingController _machineIdController = TextEditingController();
  final logger = Logger();
  ...
  Widget _buildResultList(BuildContext context) {
    return Container(
        ...
        child: _buildHistory(_detailInspection, _other));
  }

  Widget _buildHistory(
      List<DetailInspectionGetModel> detaillist, List<OtherModel> otherList) {
    ...
    List<DetailInspectionGetModel> updatedDetailList = detaillist.map((detail) {
    ...
    return StatefulBuilder(
      builder: (context, setState) {
        final results = updatedDetailList;
        return Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Row(
  ...
  Widget _buildHistoryItem(
    DetailInspectionGetModel result,
  ) {
    return Container(
      decoration: BoxDecoration(
        border: Border.all(
